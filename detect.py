...
def parse_opt():
   ...
   # parser.add_argument('--weights', nargs='+', type=str, default=r'D:\yolov5_obb-master\weights\yolov5s_csl_dotav1\weights\best.pt', help='model path(s)')
    parser.add_argument('--weights', nargs='+', type=str,default=r'D:\yolov5_obb-master\runs\train\exp34\weights\best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'D:\yolov5_obb-master\123\pr', help='file/dir/URL/glob, 0 for webcam')
